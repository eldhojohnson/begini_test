...
#ifndef BEGINI_IOS_SDK_SWIFT_H
#define BEGINI_IOS_SDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="begini_ios_sdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC14begini_ios_sdk15BeginiAuthorize")
@interface BeginiAuthorize : NSObject
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC14begini_ios_sdk18KDCircularProgress")
...
SWIFT_CLASS("_TtC14begini_ios_sdk15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(begini_ios_sdk)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(begini_ios_sdk)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(begini_ios_sdk)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(begini_ios_sdk)) <NSURLSessionTaskDelegate>
